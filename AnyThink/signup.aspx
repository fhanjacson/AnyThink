            ...
            <div class="col-8">
                <form id="SignUpForm" runat="server">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="SignUpFullName" runat="server" cssClass="form-control" placeholder="Full Name" required="required"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label>Username</label>
                        <asp:TextBox ID="SignUpUsername" runat="server" cssClass="form-control" placeholder="Username" required="required"></asp:TextBox>
                        <small id="SignUpUsernameHelp" class="form-text text-muted">6-20 character of a-z and 0-9</small>
                    </div>
                    <div class="form-group">
                        <label>Email Address</label>
                        <asp:TextBox ID="SignUpEmail" runat="server" TextMode="Email" cssClass="form-control" placeholder="Email" required="required"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label>Password</label>
                        <asp:TextBox ID="SignUpPassword" runat="server" TextMode="Password" cssClass="form-control" placeholder="Password" required="required"></asp:TextBox>
                        <small id="SignUpPasswordHelp" class="form-text text-muted">8-20 characters and at least a number</small>

                    </div>
                    <div class="form-group">
                        <label>Confirm Password</label>
                        <asp:TextBox ID="SignUpConfirmPassword" runat="server" TextMode="Password" cssClass="form-control" placeholder="Confirm Password" required="required"></asp:TextBox>
                        
                    </div>
                    
                    <div class="form-group">
                        <asp:Button ID="SignUpButton" runat="server" class="btn-block btn-lg" Text="Sign Up" OnClick="SignUpButton_Click" />
                    </div>
